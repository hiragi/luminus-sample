...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25505__auto__,writer__25506__auto__,opt__25507__auto__){
return cljs.core._write.call(null,writer__25506__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__24926__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__24926__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__24926__auto__)){
return or__24926__auto__;
} else {
...
var G__32725 = o;
(G__32725[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__32726__delegate = function (args){
...
while (G__32727__i < G__32727__a.length) {G__32727__a[G__32727__i] = arguments[G__32727__i + 0]; ++G__32727__i;}
  args = new cljs.core.IndexedSeq(G__32727__a,0);
} 
...
var args = cljs.core.seq(arglist__32728);
...
var old_32729 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_32729))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_32729)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__24914__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__32732 = jsprops;
(G__32732["defaultValue"] = value);

(G__32732["onChange"] = ((function (G__32732,v,value,on_change){
return (function (p1__32730_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32730_SHARP_);
});})(G__32732,v,value,on_change))
);
...
var vec__32734 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32734,(0),null);
var id = cljs.core.nth.call(null,vec__32734,(1),null);
var class$ = cljs.core.nth.call(null,vec__32734,(2),null);
...
var temp__4128__auto__ = (function (){var G__32736 = cljs.core.meta.call(null,v);
var G__32736__$1 = (((G__32736 == null))?null:reagent.impl.template.get_key.call(null,G__32736));
return G__32736__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__32738_32739 = v;
var G__32738_32740__$1 = (((G__32738_32739 == null))?null:reagent.impl.template.key_from_vec.call(null,G__32738_32739));
var G__32738_32741__$2 = (((G__32738_32740__$1 == null))?null:(jsprops["key"] = G__32738_32740__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__32744 = cljs.core.meta.call(null,argv);
var G__32744__$1 = (((G__32744 == null))?null:reagent.impl.template.get_key.call(null,G__32744));
return G__32744__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__32745 = (((jsprops == null))?{}:jsprops);
(G__32745["key"] = key);
...
var n__25811__auto___32746 = a.length;
var i_32747 = (0);
while(true){
if((i_32747 < n__25811__auto___32746)){
(a[i_32747] = reagent.impl.template.as_element.call(null,(a[i_32747])));

var G__32748 = (i_32747 + (1));
i_32747 = G__32748;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25811__auto___32749 = a.length;
var i_32750 = (0);
while(true){
if((i_32750 < n__25811__auto___32749)){
var val_32751 = (a[i_32750]);
if((cljs.core.vector_QMARK_.call(null,val_32751)) && ((reagent.impl.template.key_from_vec.call(null,val_32751) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32750] = reagent.impl.template.as_element.call(null,val_32751));

var G__32752 = (i_32750 + (1));
i_32750 = G__32752;
continue;
} else {
}
...
var G__32754 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32754) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32754){
